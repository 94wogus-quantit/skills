...
1. ✅ Modify the code (Phase 2)
2. ✅ Post a reply comment explaining the fix (Phase 3) - **MANDATORY**
3. ✅ Resolve the discussion (Phase 4) - **MANDATORY**
...
### Phase 0: Gather Discussion Info
...
**0-3. Get Discussion ID from GitLab**
...
### Phase 1: Analyze Comment

**1-1. Parse Comment Content**
...
**4. Then proceed with Phase 2-4** (Code fix → Reply → Resolve)
...
3. **Still proceed with Phase 3-4** (post reply explaining situation, then resolve)
```
